...
export default function Hero() {
  return (
    <section
      className={`banner_section banner_style_1 decoration_wrap ${styles["hero-container"]}`}
    >
      <div
        id="demo"
        className={`carousel slide pointer-event ${styles["carousel-container"]}`}
      ...
      >
        ...
        <div className={`${styles["carousel-indicators1"]} container`}>
            ...
            <div className="col-md-3">
              <div className="iconbox_item iconbox_overicon">
                ...
                <div className="item_content">
                  <h3 className="item_title mb-0">Online Consultation</h3>
                </div>
                <a className="item_global_link" href="appointment"></a>
              </div>
            </div>
            <div className="col-md-3">
              <div className="iconbox_item iconbox_overicon">
                ...
                <a className="item_global_link" href="groomers"></a>
              </div>
            </div>
            <div className="col-md-3">
              <div className="iconbox_item iconbox_overicon">
                ...
                <a className="item_global_link" href="vets"></a>
              </div>
            </div>
            <div className="col-md-3">
              <div className="iconbox_item iconbox_overicon">
                ...
                <a className="item_global_link" href="shop"></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img
              src="/images/banner/taking-care-pet.jpg"
              alt="Los Angeles"
              className="d-block"
          ...
          <div className="carousel-item">
            <img
              src="/images/banner/attractive-veterinarian-using-vet-clinic.jpg"
              alt="Chicago"
              className="d-block"
              style={{ width: "100%", height: "800px" }}
            />
